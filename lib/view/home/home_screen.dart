...
import 'package:biggdaddy/view/home/widgets/category_elements.dart';
import 'package:biggdaddy/view/home/widgets/category_widgets.dart';
import 'package:biggdaddy/view/home/widgets/slider_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> {
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Center(child: textWidget(text: "Welcome to Big Daddy",color: AppColors.goldencolor,fontWeight: FontWeight.bold,fontSize: width*0.036)),
          ],
        ),
        actions: [
  ...
  _launchURL2() async {
    var url = "https://bigdaddylive.in/bigdaddylive.apk";
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
