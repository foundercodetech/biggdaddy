...
import 'package:biggdaddy/model/Mlm_Plan_model.dart';
...
import 'package:biggdaddy/view/promotion/horizontal_scale.dart';
import 'package:biggdaddy/view/promotion/level_plan.dart';
                            ...
                            child: Column(
                              children: [
                                ...
                                AppBtn(
                                  ...
                                  fontWeight: FontWeight.w900,
                                  onTap: () async {
                                    String referralUrl = 'https://web.bigdaddylive.in?id=${userData.referralCode}';
                                    Share.share('Its my referral Code : *${userData.referralCode}* link to join: $referralUrl  ,'
                                        ' Download Now :https://bigdaddylive.in/bigdaddylive.apk',
                                        subject: 'Join Now !!');
                                  },
                                ):
                                AppBtn(
