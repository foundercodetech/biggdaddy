...
class ApiUrl {
  ...
  static const String baseUrl = 'https://bigdaddylive.in/';
  static const String configModel = "${baseUrl}admin/index.php/Mahajongapi/";
  static const String avaitorBaseUrl = "https://admin.bigdaddylive.in/api/aviator/";
  static const String TRXBaseUrl = "https://admin.bigdaddylive.in/api/trx/";
  ...
  static const String usdtdeposit = "https://bigdaddylive.in/admin/api/pending_payment.php";
  static const String usdtdepositHistory = "https://bigdaddylive.in/admin/api/pendingPayment_history.php?";
